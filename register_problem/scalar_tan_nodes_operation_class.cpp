...
SCALAR_TAN_NODES_OPERATION::SCALAR_TAN_NODES_OPERATION(const SCALAR_TAN_NODES_OPERATION & src_scalar_tan_nodes_operation)
{
	...
	NODE_SCALAR<char*> * node_A_identifier = new NODE_SCALAR<char*>("node_A");
	this->numeric_nodes_names_list.assignNodeValue(0, node_A_identifier);

	NODE_SCALAR<double> * local_node_A = new NODE_SCALAR<double>(0.0);
	this->local_numeric_nodes_list.assignNodeValue(0, local_node_A);
	...
	NODE_SCALAR<double> * local_previous_node_A = new NODE_SCALAR<double>(0.0);
	this->local_previous_numeric_nodes_values_list.assignNodeValue(0, local_previous_node_A);
