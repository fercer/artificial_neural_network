...
IMG_DATA * IMAGE_OPERATION::getImageData()
{
...
void IMAGE_OPERATION::setInputOperationA(IMAGE_OPERATION * src_operation_A)
{
...
void IMAGE_OPERATION::setInputOperationB(IMAGE_OPERATION * src_operation_B)
{
...
void IMAGE_OPERATION::setImageName(const char * src_image_name)
{
...
void IMAGE_OPERATION::assignNodeValue(const unsigned int src_node_position, const double src_node_value)
{
...
void IMAGE_OPERATION::assignNodeValue(const unsigned int src_node_position, const char* src_node_value)
{
...
void IMAGE_OPERATION::assignNodeValue(const unsigned int src_node_position, NODE_SCALAR<double> * src_node_pointer)
{
	if (src_node_position >= input_numeric_nodes_required)
	{
		return;
...
void IMAGE_OPERATION::assignNodeValue(const unsigned int src_node_position, NODE_SCALAR<char*> * src_node_pointer)
{
	if (src_node_position >= input_string_nodes_required)
	{
		return;
...
unsigned int IMAGE_OPERATION::getInputNumericNodesRequired()
{
...
unsigned int IMAGE_OPERATION::getInputStringNodesRequired()
{
...
char * IMAGE_OPERATION::getNumericInputName(const unsigned int src_variable_index)
{
...
char * IMAGE_OPERATION::getStringInputName(const unsigned int src_variable_index)
{
...
bool IMAGE_OPERATION::getOutputHasChanged()
{
...
void IMAGE_OPERATION::emptyImageOperation()
{
	if (dst_img)
	{
...
void IMAGE_OPERATION::copyFromImageOperation(const IMAGE_OPERATION& src_image_operation)
{
...
void IMAGE_OPERATION::computeActiveROI()
{
	...
	if ((dst_img->width != computable_width) || (dst_img->height != computable_height))
	{
		...
		dst_img->image_data.double_image_data = (double*)calloc(computable_width * computable_height, sizeof(double));
	}
...
void IMAGE_OPERATION::performImageOperation()
{
